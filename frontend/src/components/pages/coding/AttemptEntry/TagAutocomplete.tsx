...
export function TagAutocomplete(
  {tags, selectedProblem, problemsToTags}: {tags: string[], selectedProblem?: string, problemsToTags?: Record<string, string[]>}
) {
  ...
  const defaultValues = useMemo(() => 
    ...
    {console.log("problemsToTags:", problemsToTags, "selectedProblem:", selectedProblem);

    const res = problemsToTags && selectedProblem ? problemsToTags[selectedProblem] : undefined;
    console.log("res:"  , res);  
    return res;
  }
